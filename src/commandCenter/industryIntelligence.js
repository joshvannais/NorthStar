...
const tree={
  ...
  catalog:{id:'tree',displayName:'Tree service',conversationSubject:'a tree or tree debris',jobTypes:Object.keys(operations),materials:[],classificationKeywords:['tree removal','tree trimming','pruning','stump','tree debris'],scopeSchema:{required:['jobType','requestedWork','siteConcern','disposalPreference'],recommended:['treeCount','sizeClass','accessClass','conditionClass','nearStructure'],optional:['approximateHeightFeet','stumpDiameterInches','debrisLoads','disposalChoice']},questions:{discovery:[question('jobType','What tree work would you like help with?'),question('requestedWork','What should I record as the requested work?')],scope:[question('treeCount','How many trees or debris groups are involved?'),question('sizeClass','How would you describe the size?'),question('approximateHeightFeet','About how tall is the tree?'),question('stumpDiameterInches','About how wide is the stump?'),question('debrisLoads','Roughly how many loads of debris are present?'),question('accessClass','How is the access for trucks and equipment?'),question('conditionClass','What do you know about the condition?'),question('nearStructure','Is it close to a house, fence, utility, or other structure?'),question('disposalChoice','What should happen to the wood and debris?'),question('siteConcern','What would you like the team to check at the site?'),question('disposalPreference','Is there anything else the team should know about cleanup?')],scheduling:[question('timeline','When can the team contact you about an assessment?')]}},
};
