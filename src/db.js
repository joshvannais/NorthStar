    ...
    `SELECT
       ...
       (SELECT bool_and(
         ...
         WHERE namespace.nspname = 'public'
           ...
           AND relation.relname NOT LIKE 'canonical_external_labor_import_%'
