...
async function read(client,input){try{return(await client.query('SELECT public.canonical_commercial_tax_read($1,$2,$3,$4) result',args(input))).rows[0].result;}catch(e){throw failure(e);}}
