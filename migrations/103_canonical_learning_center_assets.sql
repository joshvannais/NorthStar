-- Mission 25 Part 10H: paid-tenant Learning Center inventory for labor, travel and asset sources.
...
DECLARE source_rows JSONB; source_total BIGINT; native_labor JSONB; native_equipment JSONB;
BEGIN
 ...
 RETURN jsonb_build_object('version','m25-learning-center-v3','authority','tenant_private_postgresql',
  'evaluatedAt',transaction_timestamp(),'nativeLabor',native_labor,'nativeEquipment',native_equipment,'sources',source_rows,
  'sourceTotal',source_total,'sourcesTruncated',source_total>100,
  'learningBoundary','Learning remains advisory. NorthStar does not automatically change estimates, rates, equipment plans, costs, maintenance plans, routes, schedules, payroll, worker, vehicle or equipment profiles, or business policy.');
END $$;
