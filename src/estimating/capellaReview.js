...
function buildCapellaReview(review, snapshot) {
  ...
  const direct = ['estimate-material-adoption-v1','estimate-material-adoption-v2'].includes(review.pins?.revision?.calculationVersion) ? priceCents(review.financialCosts?.knownDirectCosts) : snapshot && Object.prototype.hasOwnProperty.call(snapshot, 'knownDirectCosts') ? recordedCents(snapshot.knownDirectCosts) : null;
