...
router.post('/command-center/estimates/:estimateId/equipment-cost-preview',async function(req,res){
 ...
 }catch(e){return res.status(e.status||503).json({success:false,error:{message:e.status?e.message:'Demo equipment costs are unavailable. Refresh and try again.'}});}
});
