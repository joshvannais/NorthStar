...
The period pool declares included cost categories; separate period costs, operating rates and job fees cannot charge the same category again. One symmetric structured rule applies throughout: Operating Expenses covers fuel/energy, consumables and maintenance, so neither the parent nor its covered categories can be charged alongside the other. Disjoint insurance, setup and separate fuel/consumables/maintenance remain valid. Free-text fee names are not interpreted as category evidence. Operating costs are either one all-in rate or separate fuel/energy, consumables and maintenance rates. Each rate is known, not applicable/already included, or unknown. Up to four nonrefundable equipment-only job fees are supported. Operator labor, travel/delivery, tax, overhead and refundable deposits do not become equipment fees.
...
The shared paid/demo customer drawer adds a compact Equipment Costs disclosure inside Equipment Plan. Current and historical cost methods, rates, coverage, sources and dates are readable. Current cost-write authority permits withdrawal of active costs even when the Equipment Plan is missing, withdrawn or has changed sources. Those conditions still block new costing; they do not authorize new adoption or change immutable history. Withdrawal starts with its own reason/unchecked consent and preserves Cancel focus. The selected estimate has its own Included Equipment Cost Basis disclosure, preserved after later plan edits or withdrawal. Forms preserve useful entries, require a fresh preview/confirmation after known rejection, keep an exact request for genuinely uncertain saves, and use outcome-neutral pause wording.
