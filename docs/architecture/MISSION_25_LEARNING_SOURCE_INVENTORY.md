...
| External historical and continuous sources | `canonical_external_labor_import_consents`, `canonical_external_labor_import_runs`, `canonical_external_labor_import_records`, `canonical_external_labor_import_reference_matches`, `canonical_external_labor_import_learning_consents`, `canonical_external_labor_import_outcome_observations` and guarded external-labor routes | Older and ongoing CRM, fleet, accounting, payroll, fuel, routing, procurement and communications outcomes | Provider-neutral normalized labor/time envelope, reviewed worker/job reconciliation and a separately consented imported labor-duration outcome are released. The deterministic advisory consumes only current matched records and an adopted labor plan; corrections, tombstones, match changes and revocation stale or hide it. Provider adapters, owner UI and other source classes remain unimplemented. |
