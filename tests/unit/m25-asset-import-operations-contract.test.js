...
const operations = require('../../src/learning/externalAssetOperationsContract');

const digest = 'a'.repeat(64);

describe('Mission 25 Part 10 vehicle and equipment source operation contracts', () => {
  test('normalizes exact vehicle and equipment source lifecycle, retention, deletion and cleanup inputs', () => {
