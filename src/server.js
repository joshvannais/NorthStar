...
const pages = {
  ...
  '/dashboard/leads': 'public/dashboard.html',
  '/dashboard/calls': 'public/dashboard.html',
  '/dashboard/my-number': 'public/dashboard.html',
  '/dashboard/settings': 'public/dashboard.html',
  '/dashboard/integrations': 'public/dashboard.html',
