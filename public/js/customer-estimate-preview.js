(function (root, factory) {
  ...
  function brandImage(){if(!brandLoader)brandLoader=new Promise(function(resolve,reject){var mark=new Image();mark.onload=function(){resolve(mark);};mark.onerror=function(){reject(new Error('NorthStar mark is unavailable.'));};mark.src='/assets/logo.png';});return brandLoader;}
  ...
  function canvasBlob(estimate) {
    return brandImage().then(function(mark){
      ...
      function font(size,weight){return (weight||'400')+' '+size+'px Inter, Segoe UI, sans-serif';}
