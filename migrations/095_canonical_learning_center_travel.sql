-- Mission 25 Part 9F: paid-tenant Learning Center inventory for labor and travel sources.
-- The read model stays tenant private and advisory; it exposes no protected source table.
...
BEGIN
 ...
 RETURN jsonb_build_object('version','m25-learning-center-v2','authority','tenant_private_postgresql',
  ...
  'learningBoundary','Learning remains advisory. NorthStar does not automatically change estimates, rates, travel assumptions, routes, schedules, payroll, worker or vehicle profiles, or business policy.');
END $$;
