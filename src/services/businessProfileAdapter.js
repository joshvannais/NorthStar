 ...
 * contract consumed by the canonical Part 3 calculator. Legacy markup remains
 * visible for provenance but does not silently change current catalog prices.
 * New charges/costs are active only through explicit canonical configuration.
 */
