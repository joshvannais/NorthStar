...
function publicSources(raw){
 return stableValue({digest:raw.digest,asOfDate:raw.asOfDate,serviceKey:raw.serviceKey,simulated:raw.simulated,currency:raw.currency,sourcePins:raw.sourcePins,decisionBasis:raw.decisionBasis,pricingPin:raw.pricingPin,pricingCurrent:raw.pricingCurrent,pricing:raw.pricingCurrent&&raw.pricing?{id:raw.pricing.id,result:raw.pricing.result}:null,policyPin:raw.policyPin,profilePin:raw.profilePin,taxProfilePin:raw.taxProfilePin,rulePins:raw.rulePins,validatedRules:raw.validatedRules,sourceDigest:raw.sourceDigest});
}
