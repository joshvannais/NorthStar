...
- Unit cost, job purchase quantity and line total, reviewed vendor lineage and recorded inventory balance are evaluated independently. Missing, incompatible, ambiguous or mixed evidence remains unavailable for only the affected dimension.
