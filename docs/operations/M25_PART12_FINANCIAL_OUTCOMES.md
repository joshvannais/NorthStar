...
Each contributing external reference needs exactly one current source record and a current reviewed link to the same NorthStar estimate. Unknown accounting treatment, duplicate records, stale links, non-posted revenue or cost, unavailable amounts and mixed currencies make the affected result unavailable. Missing records or amounts never become zero. No exchange rate, invoice revenue, payment collection, reversal sign or financial completeness is inferred.
