 ...
 *   calendar, operations, learning-center, team, business-profile, settings, integrations
 */
(function() {
  'use strict';
  ...
  var NAV_ITEMS = [
    ...
    { id: 'operations',       href: '/dashboard/operations',       label: 'Operations',        svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="5" y="4" width="14" height="18" rx="2"/><path d="M9 4V2h6v2M9 10h6M9 14h6M9 18h4"/></svg>' },
    { id: 'learning-center',  href: '/dashboard/learning-center',  label: 'Learning Center',   svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 3a5 5 0 0 0-5 5c0 2 1 3.5 2.5 4.5V16h5v-3.5C16 11.5 17 10 17 8a5 5 0 0 0-5-5Z"/><path d="M9.5 20h5M10 16h4M4 10H2M22 10h-2M5.5 4.5 4 3M18.5 4.5 20 3"/></svg>' },
  ...
  function buildSidebar(items, mode) {
    ...
    var footerLink = mode === 'demo'
      ...
      : supportAction() + '<button type="button" class="northstar-nav-action" data-account-logout aria-label="Sign Out" tabindex="0"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg><span>Sign Out</span></button>';
    return '' +
